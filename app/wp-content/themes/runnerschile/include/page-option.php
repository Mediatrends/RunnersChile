	...
	$page_meta_boxes = array(
			...
			'name'=>array(
				...
				'Blog'=>array(
					...
					'item-size'=>array(
						...
						'options'=>array('0'=>'1/4 Blog Grid', '2'=>'1/3 Blog Grid', '3'=>'1/2 Blog Grid', '4'=>'1/1 Blog Grid', '5'=>'1/1 Blog List',
							'6'=>'1/1 Blog Grid List', '7'=>'1/1 Medium Thumbnail'),
						'type'=>'combobox', 
						'hr'=>'none',
				...
				'Post-Slider' =>array(
					'header'=>array(
						'title'=> 'HEADER TITLE',
						'name'=> 'page-option-item-post-slider-header-title',
						'type'=> 'inputtext'),				
					'slider-type'=>array(
						'title'=>'SLIDER TYPE',
						...
						'type'=>'combobox',
						'hr'=>'none',
						'description' =>'When you use the carousel slider, please don\'t forget to fill the width and height to be smaller ( ex 160x90 )'),
					'width'=>array(
						'title'=>'SLIDER WIDTH',
					...
					'show-caption'=>array(
						...
						'type'=>'combobox',
						'options'=>array('Yes','No', 'Show Date'), 
						'hr'=>'none',
						'description'=>'Date and caption will be ignored in the carousel format.'),							
					'num-excerpt'=>array(
				...
				'Stunning-Text'=>array(			
					...
					'shadow'=>array(
						'title'=> 'ENABLE SHADOW',
						'name'=> 'page-option-item-stunning-text-shadow',
		...
		"Page Sidebar Template" => array(
			...
			'options'=>array(
				...
				'5'=>array('value'=>'no-sidebar','image'=>'/include/images/no-sidebar.png','default'=>'selected')
			)
		),
		...
		"Top Slider Type" => array(
			...
			'options'=>array('0'=>'Title', '1'=>'None', '2'=>'Nivo Slider', '3'=>'Flex Slider', '4'=>'Post Slider'),
			'type'=>'combobox',
			'hr'=>'none',
		...
		"Post Slider Open" => array( 'type'=>'open', 'id'=>'gdl-layer-slider-wrapper'),

		"Post Slider Category" => array(
			'title'=> __('POST SLIDER CATEGORY', 'gdl_back_office'),
		...
		"Post Slider Num Fetch" => array(
			'title'=> __('POST SLIDER NUM FETCH', 'gdl_back_office'),
			'name'=>'page-option-post-slider-num-fetch',
			'type'=>'inputtext',
			'default'=> '10',
			'hr'=>'none'
		),		
		
		"Post Slider Width" => array(
			'title'=> __('POST SLIDER WIDTH', 'gdl_back_office'),
		...
		"Post Slider Height" => array(
			'title'=> __('POST SLIDER HEIGHT', 'gdl_back_office'),
		...
		"Post Slider Close" => array( 'type'=>'close' ),			
		...
		"Bottom Slider Open" => array( 'type'=>'open', 'id'=>'gdl-bottom-slider-wrapper'),	
		
		"Bottom Slider Close" => array( 'type'=>'close'),	
