	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Elements Color', 'gdl_back_office') => array(
			__('Top Bar / Post Sliding', 'gdl_back_office')=>'gdl_panel_header_top_bar',
			__('Navigation', 'gdl_back_office')=>'gdl_panel_header_navigation',
			__('Body', 'gdl_back_office')=>'gdl_panel_body',
			__('Sidebar / Top Footer', 'gdl_back_office')=>'gdl_panel_sidebar_color',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_blog_port_style' => array(		
			__('DEFAULT POST SIDEBAR', 'gdl_back_office')=>array(
				...
				'options'=>array(
					...
					'3'=>array('value'=>'post-both-sidebar','image'=>'/include/images/both-sidebar-1.png'),
					'4'=>array('value'=>'post-both-sidebar-reverse','image'=>'/include/images/both-sidebar-2.png'),
					'5'=>array('value'=>'post-no-sidebar','image'=>'/include/images/no-sidebar-120.png'))),
			...
			__('RELATED POST', 'gdl_back_office')=>array(
				'type'=>'combobox',
				'name'=>THEME_SHORT_NAME.'_gdl_related_post',
				'default'=>'portfolio',
				'options'=>array('Yes', 'No')
			),	
			__('RELATED POST SIZE', 'gdl_back_office')=>array(
				'type'=>'combobox',
				'name'=>THEME_SHORT_NAME.'_gdl_related_post_size',
				'options'=>array('1/4', '1/3', '1/2', '1/1')
			),		
			__('RELATED POST NUM FETCH', 'gdl_back_office')=>array(
				'type'=>'inputtext',
				'name'=>THEME_SHORT_NAME.'_gdl_related_post_num_fetch',
				'default'=>'4'
			),			
		...
		'gdl_panel_search_archive_style' => array(
			__('SEARCH/ARCHIVE SIDEBAR', 'gdl_back_office')=>array(
				...
				'options'=>array(
					...
					'3'=>array('value'=>'both-sidebar','image'=>'/include/images/both-sidebar-1.png'),
					'4'=>array('value'=>'both-sidebar-reverse','image'=>'/include/images/both-sidebar-2.png'),
					'5'=>array('value'=>'no-sidebar','image'=>'/include/images/no-sidebar-120.png'))),
			...
			__('SEARCH/ARCHIVE ITEM SIZE', 'gdl_back_office')=>array(
				...
				'options'=>array('1/4 Blog Grid', '1/3 Blog Grid', '1/2 Blog Grid', '1/1 Blog Grid', 
								 '1/1 Medium Thumbnail', '1/1 Blog List')
			),	
		...
		'gdl_panel_font_size' => array(
			...
			__('WIDGET TITLE SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_widget_title_size','default'=>'18',
		...
		'gdl_panel_font' => array(
			...
			__('MAIN NAVIGATION FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_navigation_font', 'default'=>'- Oswald'),
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'42',
			...
			__('BANNER IMAGE', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_header_banner_image'),		
			__('BANNER LINK', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_header_banner_image_link'),		
			__('BANNER SCRIPT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_header_banner_script',
				'descripiton'=>'Banner script will be placed under the banner image ( if available )'),		
			__('BANNER TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_banner_top_margin', 'default'=>'35'),		
			__('BANNER MAX WIDTH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_banner_max_width'),		
		),
		...
		'gdl_panel_top_navigation' => array(			
			...
			__('ENABLE RANDOM POST (ON MAIN MENU)', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_enable_random_post',
				'description'=>'Turn on this option to show the random (post) icon at the right side of the main navigation' ),
			__('ENABLE POST SLIDING (UNDER MAIN MENU)', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_enable_top_sliding'),
			__('POST SLIDING CATEGORY', 'gdl_back_office')=>array('type'=>'combobox','name'=>THEME_SHORT_NAME.'_top_sliding_category', 'options'=>get_category_list( 'category' )),
			__('POST SLIDING NUM FETCH', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_top_sliding_num_fetch', 'default'=>'10'),			
		),

		'gdl_panel_background' => array(
			__('BACKGROUND TYPE', 'gdl_back_office')=>array('type'=>'combobox', 'id'=>'gdl_background_style','name'=>THEME_SHORT_NAME.'_background_style','options'=>array('0'=>'Pattern','1'=>'None','2'=>'Custom Image'),
		...
		'gdl_panel_icon_style' => array(	
			__('TOP SEARCH ICON STYLE','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_top_search_icon_type', 'options'=>array('1'=>'light','2'=>'dark')),
			__('POST SLIDING ICON STYLE','gdl_back_office')=>array( 'type'=>'combobox', 'name'=>THEME_SHORT_NAME.'_post_sliding_icon_type', 'options'=>array('1'=>'light','2'=>'dark')),
		...
		'gdl_panel_header_top_bar' => array(
			...
			__('TOP BAR BACKGROUND', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_bar_background',
				'default'=>'#000000', 'attr'=> array('background-color'), 'selector'=>'.top-navigation-wrapper' ),
			__('TOP NAV TEXT', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_text',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'.top-navigation-left a' ),
			__('TOP NAV TEXT CURRENT', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_text_current',
				'default'=>'#dddddd', 'attr'=> array('color'), 'selector'=>'.top-menu li a:hover, .top-menu li.current-menu-ancestor a, .top-menu li.current-menu-item a, .top-menu li.current-post-ancestor a' ),
			__('TOP NAV BORDER', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_text_border',
				'default'=>'#ffffff', 'attr'=> array('border-color'), 'selector'=>'.top-navigation-left a' ),				
			__('TOP NAV SUB MENU TOP BORDER', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_border',
				'default'=>'#b6b6b6', 'attr'=> array('border-color'), 'selector'=>'ul.top-menu li.sfHover ul' ),	
			__('TOP NAV SUB MENU TOP DIVIDER', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_top_divider',
				'default'=>'#000000', 'attr'=> array('border-bottom-color'), 'selector'=>'ul.top-menu li ul li a' ),
			__('TOP NAV SUB MENU BOTTOM DIVIDER', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_bottom_divider',
				'default'=>'#383838', 'attr'=> array('border-top-color'), 'selector'=>'ul.top-menu li ul li a' ),
			__('TOP NAV SUB MENU TEXT', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_text',
				'default'=>'#bcbcbc', 'attr'=> array('color'), 
				'selector'=>'ul.top-menu li li a, ul.top-menu li.current-menu-item li a, ul.top-menu li.current-menu-ancestor li a, ul.top-menu li li.current-menu-item li a, ul.top-menu li li.current-menu-ancestor li a, ul.top-menu li.current-post-ancestor li a' ),	
			__('TOP NAV SUB MENU TEXT CURRENT', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_text_current',
				'default'=>'#ffffff', 'attr'=> array('color'), 
				'selector'=>'ul.top-menu li li a:hover, ul.top-menu li li.current-menu-item li a:hover, .top-menu li li.current-menu-ancestor li a:hover, ' .
							'ul.top-menu li li.current-menu-item a, ul.top-menu li li.current-menu-ancestor a, ul.top-menu li li.current-menu-ancestor li.current-menu-item a, ul.top-menu li li.current-post-ancestor a'),	
			__('TOP NAV SUB MENU BG', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_nav_sub_menu_bg',
				'default'=>'#282828', 'attr'=> array('background-color'), 'selector'=>'ul.top-menu ul' ),				
			...
			__('TOP SEARCH TEXT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_background',
				'default'=>'#3a3a3a', 'attr'=> array('background-color'), 'selector'=>'div.top-search-wrapper input[type="text"]' ),	
			__('POST SLIDING BAR BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_sliding_bar_background',
				'default'=>'#333333', 'attr'=> array('background-color'), 'selector'=>'div.header-top-marquee' ),		
			__('POST SLIDING BAR HEAD TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_sliding_bar_head_text',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'div.header-top-marquee .marquee-head' ),				
			__('POST SLIDING BAR LINK', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_sliding_bar_link',
				'default'=>'#c7c7c7', 'attr'=> array('color'), 'selector'=>'div.header-top-marquee .marquee-wrapper a' ),
			__('POST SLIDING BAR BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_sliding_bar_bottom_border',
				'default'=>'#d10000', 'attr'=> array('border-color'), 'selector'=>'div.header-top-marquee' ),				
		),
		...
		'gdl_panel_header_navigation' => array(	
			__('MAIN NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background',
				'default'=>'#000000', 'attr'=> array('background-color'), 'selector'=>'.gdl-navigation-wrapper, .main-navigation-wrapper, .sf-menu li a'),			
			__('MAIN NAVIGATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background_hover',
				'default'=>'#cf2121', 'attr'=> array('background-color'), 'selector'=>'.sf-menu li a:hover'),	
			__('MAIN NAVIGATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background_current',
				'default'=>'#cf2121', 'attr'=> array('background-color'), 'selector'=>'.sf-menu li.current-menu-ancestor a, .sf-menu li.current-menu-item a, .sf-menu li.current-post-ancestor a'),				
			__('MAIN NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'.sf-menu li a, div.random-post a',
			...
			__('SUB NAVIGATION BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_top_border',
				'default'=>'#ce2121', 'attr'=> array('border-bottom-color'), 'selector'=>'ul.sf-menu ul.sub-menu' ),				
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text',
				...
				'selector'=>'ul.sf-menu li li a, ul.sf-menu li.current-menu-item li a, ul.sf-menu li.current-menu-ancestor li a, ul.sf-menu li li.current-menu-item li a, ul.sf-menu li li.current-menu-ancestor li a, ul.sf-menu li.current-post-ancestor li a' ),
			__('SUB NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background',
				'default'=>'#171717', 'attr'=> array('background-color'), 
				'selector'=>'ul.sf-menu li li a, ul.sf-menu li.current-menu-item li a, ul.sf-menu li.current-menu-ancestor li a, ul.sf-menu li li.current-menu-item li a, ul.sf-menu li li.current-menu-ancestor li a, ul.sf-menu li.current-post-ancestor li a' ),
			__('SUB NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_hover',
				'default'=>'#ffffff', 'attr'=> array('color'), 
				'selector'=>'ul.sf-menu li li a:hover, ul.sf-menu li li.current-menu-item li a:hover, .sf-menu li li.current-menu-ancestor li a:hover'),
			__('SUB NAVIGATION BACKGROUND HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background_hover',
				'default'=>'#cf2121', 'attr'=> array('background-color'), 
				'selector'=>'ul.sf-menu li li a:hover, ul.sf-menu li li.current-menu-item li a:hover, .sf-menu li li.current-menu-ancestor li a:hover'),
			__('SUB NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_current',
				'default'=>'#ffffff', 'attr'=> array('color'), 
				'selector'=>'ul.sf-menu li li.current-menu-item a, ul.sf-menu li li.current-menu-ancestor a, ul.sf-menu li li.current-menu-ancestor li.current-menu-item a, ul.sf-menu li li.current-post-ancestor a'),
			__('SUB NAVIGATION BACKGROUND CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_background_current',
				'default'=>'#cf2121', 'attr'=> array('background-color'), 
				'selector'=>'ul.sf-menu li li.current-menu-item a, ul.sf-menu li li.current-menu-ancestor a, ul.sf-menu li li.current-menu-ancestor li.current-menu-item a, ul.sf-menu li li.current-post-ancestor a'),				
		),		
		
		'gdl_panel_body' => array(	
			__('PAGE HEADER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_whole_header_background',
				'default'=>'#ab1b1b', 'attr'=>array('background-color'), 'selector'=>'div.header-wrapper'),		
			__('PAGE HEADER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_title_color',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'h1.page-header-title'),		
			__('PAGE HEADER CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption',
				'default'=>'#999999', 'attr'=>array('color'), 'selector'=>'div.page-header-caption'),				
			__('PAGE HEADER BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_border',
				'default'=>'#313131', 'attr'=>array('border-color'), 'selector'=>'div.page-header-inner-wrapper'),		
			__('ITEM HEADER TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_header_title',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'h3.gdl-header-title'),	
			__('ITEM HEADER BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_header_border',
				'default'=>'#313131', 'attr'=>array('border-color'), 'selector'=>'div.gdl-header-wrapper, ' . 
					'div.comment-wrapper .comment-title, div.comment-wrapper #reply-title, .gdl-item-border'),					
			__('ITEM HEADER ARROW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_item_header_arrow_color',
				'default'=>'#313131', 'attr'=>array('color'), 'selector'=>'div.gdl-header-wrapper .icon-double-angle-right'),		
			...
			__('BODY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_body_background',
				'default'=>'#404040', 'attr'=>array('background-color'), 'selector'=>'html',
			...
			__('CONTAINER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_container_background',
				'default'=>'#ffffff', 'attr'=>array('background-color'), 'selector'=>'.container.main, .gdl-container-color'),
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color',
				'default'=>'#ce2121', 'attr'=>array('color'), 'selector'=>'a',
			...
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color',
				'default'=>'#ce7777', 'attr'=>array('color'), 'selector'=>'a:hover',
		...
		'gdl_panel_sidebar_color' => array(
			__('SIDEBAR LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_color',
				'default'=>'#1f1f1f', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a' ),
			...
			__('SIDEBAR TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_color',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'.custom-sidebar-title, .custom-sidebar-title a' ),
			__('SIDEBAR TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_border_color',
				'default'=>'#313131', 'attr'=>array('border-color'), 'selector'=>'div.custom-sidebar-title-wrapper, div.gdl-tab-widget-header-wrapper' ),
			__('SIDEBAR TITLE ARROW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_arrow_color',
				'default'=>'#313131', 'attr'=>array('color'), 'selector'=>'div.gdl-sidebar-wrapper .icon-double-angle-right' ),
			__('SIDEBAR INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_info_color',
				'default'=>'#9b9b9b', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper .recent-post-widget-info, .sidebar-wrapper .recent-post-widget-info a, .sidebar-wrapper .full-post-widget-info, ' . 
					'.sidebar-wrapper .full-post-widget-info a, .sidebar-wrapper #twitter_update_list, div.recent-comment-widget .recent-comment-widget-date' ),				
			__('TAB WIDGET TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_widget_title',
				'default'=>'#a7a7a7', 'attr'=>array('color'), 'selector'=>'div.gdl-tab-widget-header-wrapper a' ),
			__('TAB WIDGET TITLE ACTIVE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_widget_title_active',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'div.gdl-tab-widget-header-wrapper a.active, div.gdl-tab-widget-header-wrapper a:hover' ),				
			...
			__('SOCIAL COUNTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_social_counter_background',
				'default'=>'#f5f5f5', 'attr'=>array('background-color'), 'selector'=>'div.gdl-social-counter-widget' ),	
			__('SOCIAL COUNTER COUNT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_social_counter_count',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'div.gdl-social-counter-widget span.count' ),	
			__('SOCIAL COUNTER TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_social_counter_text',
				'default'=>'#606060', 'attr'=>array('color'), 'selector'=>'div.gdl-social-counter-widget span.title' ),					
			...
			__('TAG CLOUD BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tagcloud_background',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'.tagcloud a' ),	
			__('TWITTER BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_twitter_background', 
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'div.footer-twitter-wrapper'),	
		...
		'gdl_panel_footer' => array(	
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color',
				'default'=>'#efefef', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a', 
			...
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.footer-wrapper a:hover', 
			...
			__('FOOTER CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_color',
				'default'=>'#919191', 'attr'=>array('color'), 'selector'=>'.footer-wrapper, .footer-wrapper table th'),	
			__('FOOTER CONTENT INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_info_color',
				'default'=>'#7f7f7f', 'attr'=>array('color'), 'selector'=>'.footer-wrapper .recent-post-widget-info, .footer-wrapper #twitter_update_list',
			...
			__('FOOTER BUTTON BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_color', 
				'default'=>'#ce2121', 'attr'=>array('background-color'), 'selector'=>'.footer-wrapper .contact-form-wrapper button',
			...
			__('FOOTER PERSONNAL INFO', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_personnal_widget_info', 
				'default'=>'#dbdbdb', 'attr'=>array('color'), 'selector'=>'div.footer-wrapper .personnal-widget-item .personnal-widget-info'),				
			...
			__('FOOTER TAG CLOUD BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_tagcloud_background', 
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper .tagcloud a'),
			...
			__('FOOTER TAB WIDGET TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_tab_widget_title',
				'default'=>'#a7a7a7', 'attr'=>array('color'), 'selector'=>'div.footer-wrapper div.gdl-tab-widget-header-wrapper a' ),
			__('FOOTER TAB WIDGET TITLE ACTIVE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_tab_widget_title_active',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'div.footer-wrapper div.gdl-tab-widget-header-wrapper a.active, div.footer-wrapper div.gdl-tab-widget-header-wrapper a:hover' ),								
			__('COPYRIGHT BORDER TOP LINE', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_top_border', 
				'default'=>'#2b2b2b', 'attr'=>array('border-top-color'), 'selector'=>'div.footer-wrapper .copyright-border'),				
		...
		'gdl_panel_slider' => array(		
			__('TOP SLIDER BOTTOM BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_slider_bottom_bar',
				'default'=>'#e8e8e8', 'attr'=>array('border-color'), 'selector'=>'div.gdl-top-slider-wrapper' ),	
			__('TOP SLIDER NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_background',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 
				'selector'=>'.ls-maxima .ls-nav-prev, .ls-maxima .ls-nav-next,' . 
			...
			__('TOP SLIDER NAVIGATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_active_background',
				'default'=>'#930000', 'attr'=>array('background-color'), 
				'selector'=>'.ls-maxima .ls-nav-prev:hover, .ls-maxima .ls-nav-next:hover, ' . 
			...
			__('SLIDER CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_caption_color',
				'default'=>'#bbbbbb', 'attr'=>array('color'), 'selector'=>'div.gdl-slider-caption'),							
			__('SLIDER BULLET COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_color',
				...
				'selector'=>'.ls-maxima .ls-bottom-slidebuttons a, .flex-control-nav li a, .nivo-controlNav a, div.anythingSlider .anythingControls ul a'),
			__('SLIDER BULLET ACTIVE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_active',
				'default'=>'#bbbbbb', 'attr'=>array('background'), 
				'selector'=>'.ls-maxima .ls-bottom-slidebuttons a.ls-nav-active, .ls-maxima .ls-bottom-slidebuttons a:hover' . 
			...
			__('STUNNING TEXT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_title_color',
				'default'=>'#cf2121', 'attr'=>array('color'), 'selector'=>'h1.stunning-text-title' ),
			__('STUNNING TEXT CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_caption_color',
				'default'=>'#7a7a7a', 'attr'=>array('color'), 'selector'=>'.stunning-text-caption'),
			__('STUNNING TEXT BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_background_color',
				'default'=>'#efefef', 'attr'=>array('background-color'), 'selector'=>'.stunning-text-inner-wrapper'),					
		),
			
		'gdl_panel_blog_pagination' => array(		
			__('BLOG PAGE TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_page_title_color',
				'default'=>'#c33030', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-full .blog-title a, div.gdl-related-post .blog-title a' ),
			__('BLOG PAGE TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_page_title_hover_color',
				'default'=>'#c33030', 'attr'=>array('color'), 'selector'=>'div.gdl-blog-full .blog-title a:hover, div.gdl-related-post .blog-title a:hover',
				'description'=>'This is the blog thumbnail title color in "hover" state.'),		
			__('BLOG ITEM TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color',
				'default'=>'#1f1f1f', 'attr'=>array('color'), 'selector'=>'h2.blog-title a, h1.blog-title a, div.portfolio-item .page-item-title a' ),
			__('BLOG ITEM TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_hover_color',
			...
			__('BLOG LIST BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_list_background',
				'default'=>'#f3f3f3', 'attr'=>array('background-color'), 'selector'=>'div.gdl-blog-list'),
			__('BLOG COMMENT (IMAGE) BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_comment_image_background',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'div.blog-media-wrapper .blog-comment, div.full-post-widget .blog-comment,' .
					'div.post-slider-comment'),	
			__('BLOG COMMENT (IMAGE) TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_comment_image_text',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.blog-media-wrapper .blog-comment, div.blog-media-wrapper .blog-comment a, '. 
					'div.full-post-widget .blog-comment, div.full-post-widget .blog-comment a, div.post-slider-comment'),				
			...
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination a:hover'),
			...
			__('PAGINATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_current_background',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination span'),
		...
		'gdl_panel_portfolio' => array(
			...
			__('PORT TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-tag a, .portfolio-item .portfolio-tag'),	
			__('PORT BOTTOM BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_border',
				'default'=>'#cf2121', 'attr'=>array('background-color'), 'selector'=>'.portfolio-item .port-bottom-border'),						
			...
			__('PORT FILTER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_color',
				'default'=>'#9c9c9c', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter li a'),		
			__('PORT FILTER ACTIVE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_border_color',
				'default'=>'#000000', 'attr'=>array('color'), 'selector'=>'ul.portfolio-item-filter li a.active, ul.portfolio-item-filter li a:hover, ul.portfolio-item-filter li span'),				
			...
			__('PORT NAV BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_carousel_nav',
				...
				'selector'=>'div.portfolio-carousel-wrapper .port-nav, div.portfolio-carousel-description .port-nav, div.single-portfolio .port-nav a, ' . 
							'div.blog-carousel-wrapper .blog-nav, div.gdl-carousel-testimonial .testimonial-navigation a'),				
		),
		...
		'gdl_panel_price_personnal_item' => array(
			...
			__('PRICE TAG ACTIVE BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_tag_active_background', 
				'default'=>'#ce2121', 'attr'=>array('background-color'), 'selector'=>'div.best-price .price-tag'),					
			...
			__('PRICE BUTTON BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_button_background', 
				'default'=>'#ce2121', 'attr'=>array('background-color'), 'selector'=>'div.price-button-wrapper .gdl-button'),
		...
		'gdl_panel_additional_elements' => array(				
			...
			__('ACCORDION BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_accordion_border',
				'default'=>'#f5f5f5', 'attr'=>array('border-color'), 'selector'=>'ul.gdl-accordion li, ul.gdl-toggle-box li, div.gdl-carousel-testimonial .testimonial-content'),
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color',
				'default'=>'#ce2121', 'attr'=>array('background-color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),					
			...
			__('PROGRESS BAR HILIGHT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_progress_bar_highlight',
				'default'=>'#ce2121', 'attr'=>array('background-color'), 'selector'=>'div.progress-bar-wrapper .progress-bar'),	
		...
		'gdl_panel_additional_elements_2' => array(		
			...
			__('TAB ACTIVE TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_title_border',
				'default'=>'#ce2121', 'attr'=>array('border-top-color'), 'selector'=>'div.gdl-tab ul.gdl-tab-title li a.active' ),	
		...
		'gdl_panel_blog_port_translator' => array(
			__('BREAKING NEWS', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_breaking_news','default'=>'BREAKING NEWS'),
			...
			__('READ ALL NEWS (BLOG)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_read_the_blog','default'=>'Read All News'),
			__('RELATED POSTS (BLOG)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_related_posts','default'=>'Related Posts'),
